...
const ALPHABET: IAlphabet[] = [
  {
    human: "0",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/0.png",
  },
  {
    human: "1",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/1.png",
  },
  {
    human: "2",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/2.png",
  },
  {
    human: "3",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/3.png",
  },
  {
    human: "4",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/4.png",
  },
  {
    human: "5",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/5.png",
  },
  {
    human: "6",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/6.png",
  },
  {
    human: "7",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/7.png",
  },
  {
    human: "8",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/8.png",
  },
  {
    human: "9",
    alien:
      "https://raw.githubusercontent.com/slimmii/alien-alphabet/master/9.png",
  },
  {
    human: "a",
    alien:
...
const AlienAlphabet = () => {
  const [selectedLetters, setSelectedLetters] = useState<IAlphabet[]>([]);
  ...
  return (
    <>
      ...
      >
        {ALPHABET.map((e, i) => (
          <button
            onClick={() => setSelectedLetters((prev) => [...prev, e])}
            style={{
              width: "50px",
              height: "50px",
              display: "flex",
      ...
      {selectedLetters && (
        <h1>
          {selectedLetters.reduce(
            (word, letter) => (word += letter.human.toUpperCase()),
            "",
          )}
        </h1>
      )}
